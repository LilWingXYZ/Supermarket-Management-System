 ...
 */
public class BaseStorageInformation extends javax.swing.JInternalFrame {
    BaseStoreBiz vbiz = new BaseStoreBizImpl();
    /**
     * Creates new form InventorySearchFrame
     */
    public BaseStorageInformation() {
        initComponents();
    }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(29, 29, 29))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(btnPrintTable, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
...
//"商品编号", "商品名称", "类型", "容量", "接口类型", "库存"商品编号", "商品名称", "当前库存", "建议采购价", "最近采购日期", "建议销售价", "最近销售日期"
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        List<BaseStore> list = vbiz.findByCondition(condition);
        showOnTable(list);
    }                                         
    ...
    private void btnPrintTableActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        List<BaseStore>list = vbiz.findByCondition(conditions);
        String title[] = {"商品编号", "仓库编号", "商品数量"};
        ExcelWriteUtil.printSale(list, file,title,title.length); //psalelist是要导出到excel的数据集合，来自有数据库查询
        }
    }                                             

    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {                                         
        FrameUtil.framemap.remove(BaseStorageInformation.class.getName());
    }                                        
private void showOnTable(List<BaseStore> list) {
        //1 获得表格模型
