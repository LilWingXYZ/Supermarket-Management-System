 ...
 */
public class AllPurchase extends javax.swing.JInternalFrame {
    PurchaseBiz vbiz = new PurchaseBizImpl();
    /**
...
//"商品编号", "商品名称", "类型", "容量", "接口类型", "库存"商品编号", "商品名称", "当前库存", "建议采购价", "最近采购日期", "建议销售价", "最近销售日期"
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        List<Purchase> list = vbiz.findByCondition(condition);
        showOnTable(list);
    }                                         
    ...
    private void btnPrintTableActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        List<Purchase>list = vbiz.findByCondition(conditions);
        String title[] = {"商品编号", "员工编号", "供应商编号", "商品数量", "供应日期"};
...
private void showOnTable(List<Purchase> list) {
        //1 获得表格模型
